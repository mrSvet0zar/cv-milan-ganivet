  ...
  fr: {
    ...
    experiences: [
      ...
      },
      {
        ...
        location: "France",
        bullets: [
          "Responsable d'une base de données logistique de production (BASL) à grande échelle, pour des programmes navals neufs et en maintien en condition opérationnelle (MCO).",
          "Développement de procédures d'import/export en SQL / PL-SQL (Oracle, MySQL) et automatisation de tâches via macros VBA.",
          "Création et consolidation des plans de maintenance, en lien étroit et constant avec les responsables logistiques.",
          "Responsable des paramétrages métiers lors d'une refonte applicative, en agile — garant du respect des règles métiers auprès des développeurs externes.",
          "Formation des utilisateurs et conduite du changement, dans un environnement défense très contraint (habilitation Secret Défense).",
        ],
        stack: ["Oracle", "MySQL", "PL/SQL", "Excel VBA"],
  ...
  en: {
    ...
    experiences: [
      ...
      },
      {
        ...
        location: "France",
        bullets: [
          "Owner of a large-scale production logistics database (BASL) for new-build and in-service (MCO) naval programs.",
          "Developed SQL / PL-SQL import/export procedures (Oracle, MySQL) and automated tasks with VBA macros.",
          "Built and consolidated maintenance plans in close, constant coordination with logistics managers.",
          "Business-configuration lead on an application overhaul, working in agile — safeguarding business rules with the external development team.",
          "User training and change management in a highly constrained defense environment (held a 'Secret Défense' clearance).",
        ],
        stack: ["Oracle", "MySQL", "PL/SQL", "Excel VBA"],
